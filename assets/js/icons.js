...
(function () {
  ...
  var sprite = [
    ...
    // Atom — three orbits around a nucleus
    s('orbit',
      '<circle cx="32" cy="32" r="7"/>' +
      '<ellipse cx="32" cy="32" rx="26" ry="10.5"/>' +
      '<ellipse cx="32" cy="32" rx="26" ry="10.5" transform="rotate(60 32 32)"/>' +
      '<ellipse cx="32" cy="32" rx="26" ry="10.5" transform="rotate(-60 32 32)"/>' +
      '<circle cx="58" cy="32" r="1.6"/><circle cx="19" cy="9.5" r="1.6"/><circle cx="19" cy="54.5" r="1.6"/><circle cx="45" cy="54.5" r="1.6"/><circle cx="6" cy="32" r="1.6"/>',
      '0 0 64 64'),
