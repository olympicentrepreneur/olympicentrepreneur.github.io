...
(function () {
  ...
  /* ---------- i18n: small strings the JS itself generates or writes into the page ---------- */
  var LANG = root.getAttribute('lang') === 'ro' ? 'ro' : 'en';
  var STR = (function () {
    var EN = {
      menuClose: 'Close menu', menuOpen: 'Open menu',
      logSearchAds: 'Search terms reviewed, negatives added',
      logWallet: 'Daily budget pacing checked',
      logEdit: 'New ad variation launched for testing',
      logUsers: 'Audience segment refined',
      logCrosshair: 'Conversion tracking verified',
      logSpark: 'Creative refreshed to limit ad fatigue',
      logSliders: 'Bids adjusted on top keywords',
      logReturn: 'Retargeting audience updated',
      logChart: 'Weekly performance summary prepared',
      logChGoogle: 'Google Ads', logChMeta: 'Meta Ads', logChAll: 'All channels',
      agoNow: 'just now', ago12m: '12 min ago', ago1h: '1 h ago', ago3h: '3 h ago',
      hintSimple: 'One-time project price · <b>€300</b>',
      hintAdvanced: 'One-time project price · <b>€500</b> · Our most popular package',
      hintPremium: 'One-time project price · <b>€1,000</b> · Our flagship package',
      hintGoogle: 'Monthly management · <b>€300/month</b>',
      hintMeta: 'Monthly management · <b>€300/month</b>',
      hintWebsiteAds: 'A website package plus Google and/or Meta Ads management',
      hintCustom: 'Tell us what you need — we\'ll discuss scope together',
      interestedPrefix: 'I\'m interested in: ',
      errName: 'Please enter your name.',
      errEmail: 'Please enter a valid email address.',
      errPhone: 'Please enter a valid phone number.',
      errService: 'Please choose a service.',
      errMessage: 'Please tell us a little more (at least 20 characters).',
      builderEmpty: 'Select a website package or advertising service.',
      sending: 'Sending…', sendRequest: 'Send Project Request',
      sendFail: 'Sorry — your request could not be sent. Please try again in a moment, or email us at info@olympicentrepreneur.com.',
      subjectPrefix: 'New project request: ',
      catBusiness: 'Business', catRealestate: 'Real Estate', catRestaurant: 'Restaurant',
      catEcommerce: 'E-commerce', catProfessional: 'Professional Services', catPersonal: 'Personal Brand'
    };
    var RO = {
      menuClose: 'Închide meniul', menuOpen: 'Deschide meniul',
      logSearchAds: 'Termenii de căutare au fost revizuiți, s-au adăugat cuvinte de excludere',
      logWallet: 'Verificarea ritmului de execuție a bugetului zilnic',
      logEdit: 'A fost lansată o nouă variantă de reclamă în vederea testării',
      logUsers: 'Segmentul de public rafinat',
      logCrosshair: 'Urmărirea conversiilor a fost verificată',
      logSpark: 'Conținutul creativ a fost actualizat pentru a reduce oboseala publicitară',
      logSliders: 'Ofertele ajustate pentru cuvintele cheie de top',
      logReturn: 'Actualizarea publicului pentru retargeting',
      logChart: 'S-a întocmit un rezumat săptămânal al performanțelor',
      logChGoogle: 'Google Ads', logChMeta: 'Meta Ads', logChAll: 'Toate canalele',
      agoNow: 'chiar acum', ago12m: 'acum 12 minute', ago1h: 'acum 1 oră', ago3h: 'acum 3 ore',
      hintSimple: 'Preț unic pentru proiect · <b>300 €</b>',
      hintAdvanced: 'Preț unic pentru proiect · <b>500 €</b> · Cel mai popular pachet al nostru',
      hintPremium: 'Preț unic pentru proiect · <b>1.000 €</b> · Pachetul nostru de referință',
      hintGoogle: 'Administrare lunară · <b>300 €/lună</b>',
      hintMeta: 'Administrare lunară · <b>300 €/lună</b>',
      hintWebsiteAds: 'Un pachet de servicii pentru site-uri web, plus gestionarea campaniilor publicitare pe Google și/sau Meta Ads',
      hintCustom: 'Spuneți-ne de ce aveți nevoie — vom discuta împreună despre obiectul proiectului',
      interestedPrefix: 'Mă interesează: ',
      ...
      errService: 'Vă rugăm să alegeți un serviciu.',
      errMessage: 'Vă rugăm să ne oferiți mai multe detalii (cel puțin 20 de caractere).',
      builderEmpty: 'Alegeți un pachet de site web sau un serviciu de publicitate.',
      sending: 'Se trimite…', sendRequest: 'Trimite cerere de proiect',
      sendFail: 'Ne pare rău — solicitarea dumneavoastră nu a putut fi trimisă. Vă rugăm să încercați din nou peste câteva momente sau să ne trimiteți un e-mail la adresa info@olympicentrepreneur.com.',
      subjectPrefix: 'Solicitare de proiect nou: ',
      catBusiness: 'Afaceri', catRealestate: 'Imobiliare', catRestaurant: 'Restaurant',
      catEcommerce: 'Comerțul electronic', catProfessional: 'Servicii profesionale', catPersonal: 'Brandul personal'
    };
  ...
  function initMenu() {
    ...
    function set(open) {
      ...
      btn.setAttribute('aria-label', open ? STR.menuClose : STR.menuOpen);
      if (open) {
        var first = $('a', menu);
  ...
  var MS_CATS = { business: STR.catBusiness, realestate: STR.catRealestate, restaurant: STR.catRestaurant, ecommerce: STR.catEcommerce, professional: STR.catProfessional, personal: STR.catPersonal };
  ...
  function initDial() {
    ...
    function render(e) {
      ...
      inner.forEach(function (c, k) { c.style.strokeDashoffset = (1 - clamp(e * 1.4 - k * 0.08, 0, 1)).toFixed(4); });
    }
    render(0);
  ...
  function initDashboard() {
    ...
    var LOG = [
      ['search-ads', STR.logSearchAds, STR.logChGoogle],
      ['wallet', STR.logWallet, STR.logChAll],
      ['edit', STR.logEdit, STR.logChGoogle],
      ['users', STR.logUsers, STR.logChMeta],
      ['crosshair', STR.logCrosshair, STR.logChAll],
      ['spark', STR.logSpark, STR.logChMeta],
      ['sliders', STR.logSliders, STR.logChGoogle],
      ['return', STR.logReturn, STR.logChMeta],
      ['chart', STR.logChart, STR.logChAll]
    ];
    ...
    function renderLog(isNew) {
      var html = '';
      var ages = [STR.agoNow, STR.ago12m, STR.ago1h, STR.ago3h];
  ...
  function initBuilder() {
    ...
    function update() {
      ...
      list.innerHTML = items.length
        ...
        : '<li class="empty">' + STR.builderEmpty + '</li>';
      var service = 'custom';
  ...
  function initForm() {
    ...
    var HINTS = {
      simple: STR.hintSimple,
      advanced: STR.hintAdvanced,
      premium: STR.hintPremium,
      google: STR.hintGoogle,
      meta: STR.hintMeta,
      'website-ads': STR.hintWebsiteAds,
      custom: STR.hintCustom
    };
    var svc = params.get('service');
    if (svc && Array.prototype.some.call(sel.options, function (o) { return o.value === svc; })) sel.value = svc;
    var plan = params.get('plan');
    if (plan && !msg.value) msg.value = STR.interestedPrefix + plan.slice(0, 200) + '.\n\n';

    var rules = {
      name: function (v) { return v.trim().length >= 2 || STR.errName; },
      email: function (v) { return /^[^\s@]+@[^\s@]+\.[^\s@]{2,}$/.test(v.trim()) || STR.errEmail; },
      phone: function (v) { var t = v.trim(); return !t || (/^[+()\d\s.\-]+$/.test(t) && t.replace(/\D/g, '').length >= 6) || STR.errPhone; },
      company: function () { return true; },
      service: function (v) { return !!v || STR.errService; },
      message: function (v) { return v.trim().length >= 20 || STR.errMessage; }
    };
    ...
    form.addEventListener('submit', function (e) {
      ...
      $('.btn__label', btn).textContent = STR.sending;
      var endpoint = form.getAttribute('data-endpoint');
      var done = function (ok) {
        btn.classList.remove('is-loading');
        $('.btn__label', btn).textContent = STR.sendRequest;
        if (!ok) { alert(STR.sendFail); return; }
      ...
      // Send readable values: the service's label instead of its key, and a subject naming the request.
      var data = new FormData(form);
      var service = sel.options[sel.selectedIndex].text;
      data.set('service', service);
      data.set('_subject', STR.subjectPrefix + service + ' — ' + form.elements.name.value.trim());
